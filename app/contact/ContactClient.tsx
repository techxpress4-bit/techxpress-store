      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8">
          ...
          {whatsapp && (
            ...
            >
              <div
                ...
                style={{ background: "linear-gradient(135deg, #25D366, #128C7E)", boxShadow: "0 4px 15px rgba(37,211,102,0.35)" }}
              >
              ...
              <div className="min-w-0">
                <p className="font-bold text-white text-sm" style={{ fontFamily: "var(--font-syne)" }}>WhatsApp</p>
                <p className="text-xs text-[#6b7280] mt-0.5 truncate">Réponse rapide · Disponible maintenant</p>
              </div>
              <span className="ml-auto text-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity text-lg">→</span>
            </a>
          )}
          ...
          >
            ...
            <div className="min-w-0">
              <p className="font-bold text-white text-sm" style={{ fontFamily: "var(--font-syne)" }}>Instagram</p>
              <p className="text-xs text-[#6b7280] mt-0.5">@dztechxpress</p>
            </div>
          </a>
          ...
          >
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
              style={{ background: "#010101", boxShadow: "0 4px 15px rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.12)" }}
            >
              <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="min-w-0">
              <p className="font-bold text-white text-sm" style={{ fontFamily: "var(--font-syne)" }}>TikTok</p>
              <p className="text-xs text-[#6b7280] mt-0.5">@techxpress23</p>
            </div>
          </a>
        </div>

        {/* Main grid: form + infos */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div
              ...
              style={{ background: "var(--card)", border: "1px solid rgba(107,63,160,0.2)" }}
            >
              <h2 className="font-bold text-white text-lg mb-6" style={{ fontFamily: "var(--font-syne)" }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div
              className="rounded-2xl p-5"
              style={{
                background: "linear-gradient(135deg, rgba(107,63,160,0.15), rgba(107,63,160,0.05))",
                border: "1px solid rgba(107,63,160,0.25)",
              }}
            >
              <p className="text-xs text-[#9ca3af] leading-relaxed">
                Disponible du{" "}
                <span className="text-white font-semibold">samedi au jeudi</span>,
                de <span className="text-white font-semibold">9h à 20h</span>.
                Pour les urgences, contactez-nous directement sur WhatsApp.
              </p>
            </div>
          </div>
