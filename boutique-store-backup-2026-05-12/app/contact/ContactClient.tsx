    ...
    <div className="pt-24 pb-20 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="section-title mb-3">Comment pouvons-nous<br />vous aider ?</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {whatsapp && (
              ...
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "linear-gradient(135deg, #25D366, #128C7E)", boxShadow: "0 4px 15px rgba(37,211,102,0.3)" }}>
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6b7280]">Réponse rapide • Disponible</p>
                </div>
              </a>
            )}
            ...
            <div className="flex gap-3">
              ...
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)", boxShadow: "0 4px 15px rgba(225,48,108,0.3)" }}>
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6b7280]">@dztechxpress</p>
                </div>
              </a>
              ...
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-black" style={{ boxShadow: "0 4px 15px rgba(255,255,255,0.15)" }}>
                  <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6b7280]">@techxpress23</p>
                </div>
              </a>
            </div>

            <div className="card p-5">
              <h3 className="font-bold text-white text-sm mb-4" style={{ fontFamily: "var(--font-syne)" }}>
                Infos utiles
              </h3>
                ...
                {[
                  ...
                  <div key={info.label} className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#f5f5f5] font-medium text-xs">{info.value}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="card p-6">
              <h2 className="font-bold text-white mb-5" style={{ fontFamily: "var(--font-syne)" }}>
