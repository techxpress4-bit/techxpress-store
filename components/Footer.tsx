...
export default function Footer() {
  ...
  return (
    <footer className="mt-20" style={{ borderTop: "1px solid #1f1f1f", background: "#080808" }}>
      ...
      {/* Accent bar */}
      <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, var(--violet), var(--violet-light), var(--violet), transparent)" }} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              <div className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-[#9ca3af]"
              ...
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-[#9ca3af]"
                style={{ border: "1px solid #2a2a2a", background: "#111" }}>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-xs font-bold text-white mb-5 uppercase tracking-widest" style={{ fontFamily: "var(--font-syne)" }}>
              Catégories
            </h3>
              ...
              {categories.map((cat) => (
                <li key={cat.slug}>
                  <Link href={`/catalogue/${cat.slug}`}
                    ...
                    <span className="w-1 h-1 rounded-full bg-[#2a2a2a] group-hover:bg-[#6b3fa0] transition-colors flex-shrink-0" />
                    {cat.nom}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/contact"
                  className="flex items-center gap-3 text-sm text-[#6b7280] hover:text-[#8b5fc0] transition-colors group">
                  <span className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#111] border border-[#2a2a2a] group-hover:border-violet transition-all flex-shrink-0">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
            {[
              ...
              <span key={l.href} className="flex items-center gap-3">
                <Link href={l.href} className="text-[10px] text-[#282828] hover:text-[#4a4a4a] transition-colors">
                  {l.label}
                </Link>
                {i < arr.length - 1 && <span className="text-[#222]" aria-hidden>·</span>}
              </span>
            ))}
          </div>
          <p className="text-xs text-[#3d3d3d]">
